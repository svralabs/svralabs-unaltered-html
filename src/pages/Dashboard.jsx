  ...
  return (
    <div className="app-container" data-purpose="main-application-shell">
      ...
      <main className="main-content">
        {/* Top Status Bar */}
        <header
          className="sticky top-0 bg-white flex justify-end gap-[18px] p-[14px_24px] border-b-2 border-[rgb(229,229,229)] z-10"
        ...
        {/* Unit Banner */}
        <section
          className="bg-[rgb(88,204,2)] text-white rounded-2xl p-[18px_22px] m-6 flex justify-between items-center shadow-[0_4px_0_#61B800]"
          data-purpose="unit-header"
        >
          <div className="meta">
        ...
        <section className="path-container" data-purpose="learning-path">
          ...
          <div className="node-wrap" style={{ marginLeft: '-50px' }}>
            ...
            <div className="info-bubble">
              <div className="text-[11px] font-extrabold uppercase tracking-[0.5px] text-[rgb(88,204,2)]">
                Lanjutkan
              </div>
              <div className="text-[13px] font-bold text-[rgb(75,75,75)] my-1 mb-2.5">
                Pelajaran 4 · Restoran
              </div>
      ...
      <aside className="right-rail p-[24px_20px] flex flex-col gap-5 border-l-2 border-[rgb(229,229,229)]">
        ...
        <div
          className="bg-gradient-to-br from-[#9b6bff] to-[#7d3cff] text-white rounded-2xl p-[18px]"
          data-purpose="super-promo"
        >
          <h3 className="text-white text-[15px] font-extrabold uppercase tracking-[0.5px] mb-3.5">
            Super Duolingo
          </h3>
          <p className="text-[13px] font-semibold text-[rgba(255,255,255,0.85)] mb-3.5 leading-[1.45]">
            Belajar tanpa batas dengan hati tak terbatas dan bebas iklan. Coba gratis 1 minggu.
          </p>
          <button className="btn-duo w-full bg-white text-[#7d3cff] shadow-[0_4px_0_rgba(0,0,0,0.18)]">
