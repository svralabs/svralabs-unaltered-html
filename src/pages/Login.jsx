    ...
    <main className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.titleContainer}>
          <h1 className={styles.title}>JastipBuddy</h1>
          <p className={styles.subtitle}>Selamat Datang di JastipApp</p>
        </div>
      </header>
      ...
      <footer className={styles.footer}>
        <p className={styles.footerText}>
          Belum punya akun? <a className={styles.link} href="#">Daftar</a>
        </p>
      </footer>
    </main>
  );
